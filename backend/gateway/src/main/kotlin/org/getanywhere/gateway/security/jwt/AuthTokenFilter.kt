...
import org.getanywhere.gateway.security.services.UserDetailsServiceImpl
...
class AuthTokenFilter(private val jwtUtils: JwtUtils, private val userDetailsService: UserDetailsServiceImpl) : OncePerRequestFilter() {
